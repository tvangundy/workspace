...
If you're new to IncusOS, we recommend starting with the [IncusOS Server](../bootstrapping/nuc-incusos.md) runbook to get your IncusOS server up and running. Once your server is configured, you can proceed with any of the deployment runbooks based on your needs:
...
- **IncusOS system**: An IncusOS host with Incus installed and running (see [IncusOS Server](../bootstrapping/nuc-incusos.md))
